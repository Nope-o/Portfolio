...
class PitchVisualizerApp {
  ...
  async initialize() {
    ...
    try {
      ...
      trackAnalyticsEvent('sursight_opened', { version: '2.1.1' }, { dedupeKey: 'sursight_opened_once' });
  ...
  updateSystems(displayFreq, pitchResult, analyser, signalState, insightState = null) {
    ...
    if (recording.getRecordingState()) {
      recording.addDataPoint(displayFreq, pitchResult.clarity, pitchResult.rms);
    }
