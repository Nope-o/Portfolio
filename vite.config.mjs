  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        phononiumApp: path.resolve(ROOT, 'projects/phononium-app/index.html'),
        ...
        phononiumDetail: path.resolve(ROOT, 'projects/phononium/index.html'),
